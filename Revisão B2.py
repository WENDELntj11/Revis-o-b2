...
def cadastrar_livros():
  ...
  in_titulo = input("Insira o titulo do livro: ")
  in_autor = input(f"Digite o autor do livro {in_titulo}: ")
  in_ano_publicacao = int(input(f" Por favor digite o ano de publicação do livro {in_titulo}: "))
...
def remover_livro():
  ...
  id_remover = int(input("\tPor favor digite o ID do livro que deseja remover: "))
...
while True:
  ...
  if(opcao == 4):
    ...
    print(" Ops, esta opção e invalida! ")